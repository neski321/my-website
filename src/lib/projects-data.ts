...
export const projects: ProjectType[] = [
...

  {
    ...
    description: "NeskiApply.AI is a smart job search assistant that helps you find and apply to jobs more efficiently. The platform automatically searches for jobs from multiple sources including Indeed, JSearch, and Adzuna, and brings them all together in one place. You can set it to automatically search for new jobs on a schedule that works for you.\n\n\nWhen you upload your resume, the system uses advanced AI technology to compare it against job descriptions and tell you how well you match. It shows you a match score, highlights missing keywords that employers are looking for, and gives you specific suggestions on how to improve your resume for each job. You can save multiple analyses for the same job and easily switch between them to see how your resume improvements affect your match score over time.\n\n\nThe Resume Optimizer takes things further by automatically rewriting your resume to better match a specific job posting. It restructures your professional summary, reorders bullet points, and weaves in missing keywords while keeping your real experience intact. You can then download the optimized resume as a PDF or Word document, ready to submit.\n\n\nWhen you land an interview, the Interview Prep feature has you covered. It generates tailored interview questions across three difficulty modes: Screening for first-round recruiter calls, Technical Deep Dive for challenging architecture and debugging scenarios, and Pressure Test for tough senior-level probing. You can step through questions one by one in a clean card view or see them all at once.\n\n\nIf you already have interview questions in hand, you can paste them in and get two types of AI-generated answers. Technical answers give you detailed, STAR-method responses grounded in your actual resume experience with specific projects, metrics, and tools you have used. Behavioral answers take the same questions and reframe them around soft skills, teamwork, leadership, and alignment with the company's values and culture. Both can be simplified with one click into plain, accessible language that anyone can deliver confidently.\n\n\nThe dashboard gives you a clear overview of your job search progress. You can see how many jobs you have found, which ones you have viewed, which ones you have applied to, and track your interview rates. The system keeps a complete history of everything that happens, so you always know what is going on with your job search.\n\n\nFinding the right jobs is easy with powerful filtering and sorting tools. You can filter jobs by whether you have applied or not, see which jobs came from which source, and sort them by how recently they were posted, your match score, company name, or date. The job feed is designed to work beautifully on your phone, tablet, or computer.\n\n\nNever miss an opportunity with smart notifications. The system can send you alerts through Discord when it finds jobs that are a great match for you. You can also set up daily reminders at any time you choose through n8n workflows to help you stay on track with your applications.\n\n\nManaging your resumes is simple. Just upload your resume file (PDF or Word document) and the system automatically extracts all your information including your skills, work experience, and education. You can keep separate resumes for job matching and interview prep, edit and update them anytime, and the system will use the right version for each purpose.\n\n\nFor teams and organizations, there is an admin panel that lets you manage multiple users. The platform is built with modern technology to ensure it is fast, reliable, and secure. Everything is designed to work smoothly whether you are on your phone or computer, with a clean, easy-to-use interface that makes job searching less stressful and more organized.",
